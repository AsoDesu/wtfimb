...
@Service
@Profile("!test")
class StagecoachServiceImpl(val objectMapper: ObjectMapper) : StagecoachService {
    ...
    override fun monitorStops(stop: String, lookAhead: Int, serviceFilter: List<String>): StopMonitorResponse {
    ...
    override fun stopEvents(stop: String, maxEvents: Int): StopEvents {
    ...
    override fun serviceTimetable(service: dev.asodesu.wherebus.stagecoach.schema.Service): ServiceTimetableResponse {
    ...
    override fun serviceTimetable(serviceId: String, departureTime: Long, originStop: String): ServiceTimetableResponse {
    ...
    override fun getStagecoachColor() = Color(colors.random().toInt(16))
